...
function yo(self) {
    ...
    var css = '#yohoho-loading{z-index:9999;width:100%;height:auto;background:#' + bg + ' url(' + options_loading + ') 50% 50% no-repeat}#yohoho-buttons{position:relative;z-index:9999;right:0;top:50px;text-align:left}#yohoho-buttons:hover{right:0!important}#yohoho-buttons div{font-family:Verdana,sans-serif;font-weight:normal;text-shadow:none;line-height:normal;font-size:' + 12 * options.button_size + 'px;color:#fff;background:#' + bg + ';border-radius:5px 0 0 5px;padding:5px;margin:5px 0 5px 5px;opacity:.7;}#yohoho-buttons div:hover,#yohoho-buttons div.yohoho-active{color:#fff;width:100%;height:auto;background:#' + bg + ';cursor:pointer;opacity:1}';
